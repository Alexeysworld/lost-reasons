...
| `5208e37662d6121470edf154a86c7c895fa32e18` | Участники первой встречи (нужно для «Не заинтересовали гендира на первой встрече») |
...
**Источник продажи для дайджест-графика** (`af70f939…`): 56→Холодные, 58→Горячие
(«Заявка»), 63/3977→Ивент/контент. Все остальные значения и **пустое поле → Холодные**
(правило заказчика). Три корзины графика: Холодные / Горячие / Ивент-контент.
